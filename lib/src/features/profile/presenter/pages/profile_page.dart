...
class _ProfilePageState extends State<ProfilePage> {
  ...
  final _nameController = TextEditingController(text: 'Zé da Manga');
  final _emailController = TextEditingController(text: 'teste@gmail.com');
  final _addressController = TextEditingController(text: 'Rua Teste, 123, Taubaté');
              ...
              Padding(
                ...
                child: Align(
                  ...
                  child: Column(
                    ...
                    children: [
                      Text('Dados cadastrais', style: TextStyle(fontSize: 20, fontWeight: FontWeight.bold),),
                      Text('Mantenha sempre seus dados atualizados.', style: TextStyle(fontSize: 16, color: AppColors.textColor),),
                    ],
                  )),
              ),
              SizedBox(height: 10,),
              ...
              Padding(
                ...
                child: Align(
                  ...
                  child: Column(
                    ...
                    crossAxisAlignment: CrossAxisAlignment.start,
                    children: [
                      Text('Alterar senha', style: TextStyle(fontSize: 20, fontWeight: FontWeight.bold),),
                      Text('Sua senha deve conter 8 caracteres, um número, uma letra maíuscula, uma letra minúscula e um caractere especial (!@#\$%&*).', style: TextStyle(fontSize: 16, color: AppColors.textColor),),
                    ],
                  )),
              ),
              SizedBox(height: 10,),
